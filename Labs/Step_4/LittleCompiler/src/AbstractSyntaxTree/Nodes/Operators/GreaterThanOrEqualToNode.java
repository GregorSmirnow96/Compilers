 ...
 * @author im5no
 */
public class GreaterThanOrEqualToNode extends ASTNode
{
    ...
    {
        List<TACLine> completeGreaterOrEqTAC = new ArrayList<>();
        ...
        completeGreaterOrEqTAC.add(tac);
        return completeGreaterOrEqTAC;
    }
}